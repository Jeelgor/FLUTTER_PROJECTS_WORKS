...
counter = 0
id = -1
imgStudent = np.zeros((216, 216, 3), dtype=np.uint8)  # Initialize as a blank image
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    if isinstance(imgStudent, np.ndarray):  # Check if imgStudent is a NumPy array (image)
